...
x_train = x[0:int(VALID_PERCENTAGE*len(x))]
y_train = y[0:int(VALID_PERCENTAGE*len(y))]
x_valid = x[int(VALID_PERCENTAGE*len(x)):-1]
y_valid = y[int(VALID_PERCENTAGE*len(y)):-1]
